(function($, undefined) {
    var defaults = {
        ...
        aspectRatio: 1.35,
        header: {
            left: fullcalendar_string.title,
            center: '',
            right: fullcalendar_string.today_previous_next
        },
        weekends: true,
        allDayDefault: true,
        ignoreTimezone: true,
        lazyFetching: true,
        startParam: fullcalendar_string.start,
        endParam: fullcalendar_string.end,
        titleFormat: {
            month: 'MMMM yyyy',
        ...
        isRTL: false,
        firstDay: 0,
        monthNames: fullcalendar_string.months,
        monthNamesShort: fullcalendar_string.months_short,
        dayNames: fullcalendar_string.days,
        dayNamesShort: fullcalendar_string.days_short,
        buttonText: {
            prev: '&nbsp;&#9668;&nbsp;',
            next: '&nbsp;&#9658;&nbsp;',
            prevYear: '&nbsp;&lt;&lt;&nbsp;',
            nextYear: '&nbsp;&gt;&gt;&nbsp;',
            today: fullcalendar_string.today,
            month: fullcalendar_string.month,
            week: fullcalendar_string.week,
            day: fullcalendar_string.day
        },
        theme: false,
        buttonIcons: {
    ...
    var rtlDefaults = {
        header: {
            left: fullcalendar_string.next_previous_today,
            center: '',
            right: fullcalendar_string.title
        },
        buttonText: {
            prev: '&nbsp;&#9658;&nbsp;',
            next: '&nbsp;&#9668;&nbsp;',
    ...
    function Header(calendar, options) {
        ...
        function render() {
            ...
            if (sections) {
                element = $("<div class='col-xs-12'/>").append(renderSection(12,'center')).append(renderSection(5,'left')).append(renderSection(7,'right'));
                return element
            }
        }
        ...
        function renderSection(size, position) {
            var e = $("<div class='row'/>").append("<div class='col-xs-" + size + " text-" + position + "'/>");
                    ...
                    $.each(this.split(','), function(j, buttonName) {
                        if (buttonName == 'title') {
                            ...
                            if (buttonClick) {
                                ...
                                var button = $("<span class='btn btn-sm btn-default fc-button-" + buttonName + " " + tm + "-state-default'>" + "<span class='fc-button-inner'>" + "<span class='fc-button-content'>" + (icon ? "<span class='fc-icon-wrap'>" + "<span class='ui-icon ui-icon-" + icon + "'/>" + "</span>" : text) + "</span>" + "<span class='fc-button-effect'><span></span></span>" + "</span>" + "</span>");
                                if (button) {
    ...
    function hpadding(element) {
        return (parseFloat($(element[0]).css('paddingLeft')) || 0) + (parseFloat($(element[0]).css('paddingRight')) || 0)
    }

    function hmargins(element) {
        return (parseFloat($(element[0]).css('marginLeft')) || 0) + (parseFloat($(element[0]).css('marginRight')) || 0)
    }

    function hborders(element) {
        return (parseFloat($(element[0]).css('borderLeftWidth')) || 0) + (parseFloat($(element[0]).css('borderRightWidth')) || 0)
    }
    ...
    function vpadding(element) {
        return (parseFloat($(element[0]).css('paddingTop')) || 0) + (parseFloat($(element[0]).css('paddingBottom')) || 0)
    }

    function vmargins(element) {
        return (parseFloat($(element[0]).css('marginTop')) || 0) + (parseFloat($(element[0]).css('marginBottom')) || 0)
    }

    function vborders(element) {
        return (parseFloat($(element[0]).css('borderTopWidth')) || 0) + (parseFloat($(element[0]).css('borderBottomWidth')) || 0)
    }
    ...
    function AgendaEventRenderer() {
        ...
        function renderSlotSegs(segs, modifiedEventId) {
            var i, segCnt = segs.length,
                ...
                hsideCache = {},
                key, val, contentElement, height, slotSegmentContainer = getSlotSegmentContainer(),
