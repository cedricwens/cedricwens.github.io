...
!function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = {
        formatLoadingMessage: function () {
            return bootstrap_table_string.load;
        },
        ...
        formatSearch: function () {
            return bootstrap_table_string.search;
        },
        formatNoMatches: function () {
            return bootstrap_table_string.no_records;
        },
        formatRefresh: function () {
            return bootstrap_table_string.reload;
        },
        formatToggle: function () {
            return bootstrap_table_string.toggle;
        },
        formatColumns: function () {
            return bootstrap_table_string.columns;
        }
    };
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            ...
            html.push(
                ...
                '</div>');*/
                '<div class="right-inner-addon pull-' + this.options.searchAlign + ' search"><i class="glyphicon glyphicon-search"></i>',
                sprintf('<input class="form-control" type="text">'),
                '</div>');
            this.$toolbar.append(html.join(''));
